...
cd "project\cprd_data\gold_primary_care_all\stata\eventlists\valid_gp"
...
clear
cd "project\cprd_data\gold_primary_care_all\stata\eventlists\valid_gp\participant_flow"	
...
duplicates drop // (52,503 observations deleted) 749,479. We have 749,479 people with an event +/-4 weeks the clock changes only including valid gp events.
