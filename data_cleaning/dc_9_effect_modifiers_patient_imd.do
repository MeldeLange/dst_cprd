*dc_9_Create effect modifiers from patient & deprivation files
***********************************************************
...
*1a) Loop to open the 5 patient files, save patid, year of birth, month of birth, gender & marital status.
clear
...
use "eventlist_`outcome'_2.dta", clear
merge m:1 patid using "projectnumber\effect_modifiers\patient/patient_imd2.dta"
keep if _merge ==3 // I have checked we have IMD data for everyone in our eventlists. Just keep people in our eventlists.
drop _merge
save "projectnumber\cprd_data\combined\combined_eventlists\eventlist_`outcome'_3", replace
