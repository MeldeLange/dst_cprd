*an_26_stratified_final_regressions_sociodemog: tratified regressions for the first week after the clock changes vs rest of the weeks, stratified by sociodemographics


*Sex, age, deprivation, systolic blood pressure, diastolic blood pressure, bmi, alcohol status, smoking status

**Open log
log using "projectnumber\analysis\logs/stratified_final_regressions_sociodemog.log", replace // because having to use 'capture' command this doesn't log the regression outputs from part 1
