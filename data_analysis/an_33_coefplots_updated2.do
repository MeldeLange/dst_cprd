*an_33 Coefplots_updated2
****************************

*Update note on combined coefplot.
...
*Create variables we need to add estimates & 95%CIs to the plot.
gen x = _n 
gen info = "" 
replace info = "0.99 (0.958, 1.029)" if x == 1
replace info = "1.02 (1.005, 1.030)" if x == 2
