*Analysis 12:  Extract the datasets for the one-week analyses, stratified by sociodemographic effect modifiers.
******************************************************************************************************************************

*This script creates the datasets needed to repeat the main analysis (comparison of one week after the clock change) stratified by all the binary effect modifiers: age, sex, deprivation, systolic bp, diastolic bp, alcohol use, smoking and marital status.
...
cd "projectnumbercprd_data\combined\combined_eventlists"
