*Analysis 20 - Calculating the power of our one week regressions, stratified by CVD subgroup, using the standard errors.
***********************************************************************************************************************
...
*1c) Append all files.
clear
cd "projectnumber\analysis\power_calcs\stratified\subgroup"
ssc install fs
fs "*.dta*"
foreach f in `r(files)' {
	append using `f'
}
	export excel using "power_stratified_subgroup.xlsx", firstrow(variables) replace