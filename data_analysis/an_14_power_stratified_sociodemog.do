* Analysis 14 - Calculating the power of our one week regressions, stratified by sociodemographics, using the standard errors.
*****************************************************************************************************************************
...
order outcome season mod cat irr1 lci1 uci1 stderr1
 save "projectnumber\analysis\power_calcs\stratified\sociodemog/`outcome'_Autumn_`mod'_`category'.dta", replace
 }
		}
}
}
...
replace suff_powered = . if stderr1 ==.
order outcome season mod cat irr1 lci1 uci1 stderr1
 save "projectnumber\analysis\power_calcs\stratified\sociodemog/`outcome'_Spring_`mod'_`category'.dta", replace
 }
		}
}
}
...
*1c) Append all files.
clear
cd "projectnumber\analysis\power_calcs\stratified\sociodemog"
ssc install fs
fs "*.dta*"
