*Analysis 19 - Stratified regressions for the first week after the clock changes vs rest of the weeks, stratified by cvd subgroup
********************************************************************************************************************************


*This script creates the datasets needed to repeat the main analysis (comparison of one week after the clock change) for CVD (in GP & HES APC data) stratified by CVD subgroup.

*Categories: 1"Atrial Fibrillation / Arrhythmia" 2"Myocardial Infarction" 3"Stroke / TIA" 4"Other"

**Open log
log using "projectnumber\analysis\logs/stratified_regressions_cvdsub.log", replace
